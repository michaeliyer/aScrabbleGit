...
function getScoreMessage(totalScore) {
    const messages = {
            5: "That's the minimum score for a 5 point word according to Scrabble. It’s an embarrassment. AND YOU ARE HATED, ALL MESSY VANCES!!!",
            ...
            31: "Consider the authorities called. You need to hide the fuck out, bitchAss COPSE Fuckler!"
    };
